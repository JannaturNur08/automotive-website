...
const ProductUpdate = () => {
	...
	const { _id, image, name, brandName, type, price, details } = product;
	...
	const handleUpdateProduct = (e) => {
		...
		fetch(
			`https://b8a10-brandshop-server-side-jannatur-nur08-i3h4cmoem.vercel.app/brand/${_id}`,
			{
				method: "PUT",
				headers: {
	...
	return (
		<div className="bg-[#223a47]">
			<div className="bg-slate-800 mb-10">
				<Navbar></Navbar>
			</div>
			<div className="bg-[#223a47] p-24 mx-auto container ">
				<h2 className="text-4xl font-extrabold text-center text-[#e2e2e2]">
					Update Product : {name}
				</h2>
				<form onSubmit={handleUpdateProduct}>
					{/* form row */}
					<div className="mb-8 mt-5">
						<div className="form-control w-1/2 mx-auto mb-2">
